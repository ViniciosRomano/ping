...
Edit config -> Environments varieble: spring.profiles.active=dev

# application-prod.properties
server.port=8081

Edit config -> Environments varieble: spring.profiles.active=prod


# application-stg.properties
server.port=8082

Edit config -> Environments varieble: spring.profiles.active=stg